...
Uses
  Unit_Base, Unit_Settings, Unit_About;
  ...
  Try
    ...
    Begin
      ...
      If (cm Is TTrayIcon) Then
        continue;
      If cm = Form1.Version Then
        continue;
      If cm = Form1.Name Then
        continue;
      ...
      Begin
        ...
        Begin
          ...
          CheckAndSetComponentPropertyString(s, FForm.Name + '.' + (cm As TComponent).Name + '.Groups[' + inttostr(j) + '].Header');
      ...
      Begin
        ...
        Begin
          ...
          CheckAndSetComponentPropertyString(s, FForm.Name + '.' + (cm As TComponent).Name + '.items[' + inttostr(j) + '].Caption');
...
Var
  ...
  Begin
    ...
    For i := 0 To Translated.Count - 1 Do
      If SameText(Copy(Translated[i], 1, Pos('=', Translated[i]) - 1), Value) Then
      Begin
        Result := i;
        Break;
      End;
